...
- `index.html`의 준비 상태 카드를 공개 동의를 받은 실제 프로필로 교체합니다.
- 프로젝트·활동 섹션에는 확인된 프로젝트만 추가합니다.
- 공식 이메일과 커뮤니티 링크를 확인한 뒤 연락 영역에 연결합니다.
- 사진과 기타 정적 파일은 `assets/` 폴더에 넣습니다.

### 자료 준비 체크리스트

구성원 한 명을 추가할 때는 아래 정보를 함께 준비하면 카드 형식을 일관되게 유지할 수 있습니다.

- 이름, 입학 연도 또는 기수, 재학·졸업 상태
- 한두 문장의 연구 관심사 또는 소개
- 공개 가능한 프로필 사진과 대체 텍스트
- 포트폴리오, GitHub 또는 대표 프로젝트 링크
- 홈페이지 공개 동의 여부

프로젝트는 제목, 진행 기간, 한 문장 소개, 참여 구성원, 대표 이미지, 결과물 링크를 기준으로 기록합니다.
